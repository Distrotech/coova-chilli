...
class CoovaChilli:
    ...
    Socket  = '/usr/var/run/chilli.sock'
    Init    = '/usr/etc/init.d/chilli'
    DefIni  = '/usr/etc/chilli/gui-config-default.ini'
    Ini     = '/usr/etc/chilli/gui-config.ini'
    Conf    = '/usr/etc/chilli/config'
