...
struct gengetopt_args_info
{
  ...
  int mmapring_flag;	/**< @brief Enable use of MMAP Rings (in Linux only) (default=off).  */
  const char *mmapring_help; /**< @brief Enable use of MMAP Rings (in Linux only) help description.  */
  ...
  char ** uamallowed_arg;	/**< @brief Resources exempt from access check .  */
  char ** uamallowed_orig;	/**< @brief Resources exempt from access check  original value given at command line.  */
  unsigned int uamallowed_min; /**< @brief Resources exempt from access check 's minimum occurreces */
  unsigned int uamallowed_max; /**< @brief Resources exempt from access check 's maximum occurreces */
  const char *uamallowed_help; /**< @brief Resources exempt from access check  help description.  */
  ...
  int nosystemdns_flag;	/**< @brief Do not attempt to use the system DNS for DHCP (default=off).  */
  const char *nosystemdns_help; /**< @brief Do not attempt to use the system DNS for DHCP help description.  */
  ...
  char ** authedallowed_arg;	/**< @brief Resources exempt from session limitations.  */
  char ** authedallowed_orig;	/**< @brief Resources exempt from session limitations original value given at command line.  */
  unsigned int authedallowed_min; /**< @brief Resources exempt from session limitations's minimum occurreces */
  unsigned int authedallowed_max; /**< @brief Resources exempt from session limitations's maximum occurreces */
  const char *authedallowed_help; /**< @brief Resources exempt from session limitations help description.  */
  int uamauthedallowed_flag;	/**< @brief Use uamallowed as resources exempt from session limitations (default=off).  */
  const char *uamauthedallowed_help; /**< @brief Use uamallowed as resources exempt from session limitations help description.  */
  ...
  int postauthproxyssl_flag;	/**< @brief Send SSL to upstream transparent proxy (default=off).  */
  const char *postauthproxyssl_help; /**< @brief Send SSL to upstream transparent proxy help description.  */
  ...
  char * ipv6mode_orig;	/**< @brief IPv6 mode is either 6and4 (default), 4to6, or 6to4 original value given at command line.  */
  const char *ipv6mode_help; /**< @brief IPv6 mode is either 6and4 (default), 4to6, or 6to4 help description.  */
  ...
  unsigned int mmapring_given ;	/**< @brief Whether mmapring was given.  */
  ...
  unsigned int nosystemdns_given ;	/**< @brief Whether nosystemdns was given.  */
  ...
  unsigned int authedallowed_given ;	/**< @brief Whether authedallowed was given.  */
  unsigned int uamauthedallowed_given ;	/**< @brief Whether uamauthedallowed was given.  */
  ...
  unsigned int postauthproxyssl_given ;	/**< @brief Whether postauthproxyssl was given.  */
